...
| Belge | Kime | İçerik |
|-------|------|--------|
| [TRADE_ASSISTANT.md](TRADE_ASSISTANT.md) | Kullanıcı / LLM | Tek komut, çıktı alanları, chat prompt |
| [ANALYSIS_PIPELINE.md](ANALYSIS_PIPELINE.md) | Geliştirici / denetim | Teknik + temel + fusion kapıları, tutarlılık |
...
| [LINKEDIN_POST.md](LINKEDIN_POST.md) | Paylaşım | İngilizce tanıtım metni |
| [images/README.md](images/README.md) | Demo | Ekran görüntüsü üretimi |

**Sürüm:** trade assistant katmanı **v0.4.0** (`pyproject.toml`). Quant araçları (backtest, Markowitz, …) aynı pakette, ayrı katman.
